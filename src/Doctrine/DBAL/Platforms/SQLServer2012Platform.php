...
class SQLServer2012Platform extends AbstractPlatform
{
    ...
    public function getListTablesSQL()
    {
        ...
        */
        ...
        return "SELECT name, 'dbo' AS schema_name FROM sysobjects WHERE type = 'U' ORDER BY name";
    ...
    public function getListTableColumnsSQL($table, $database = null)
    {
        ...
        */
        ...
        return "SELECT    col.name,
                            ...
                            col.is_identity AS autoincrement,
                            col.collation_name AS collation,
                            CAST(prop.value AS NVARCHAR(255)) AS comment -- CAST avoids driver error for sql_variant type
                    FROM      sysobjects.columns AS col
                    JOIN      sysobjects.types AS type
                    ON        col.user_type_id = type.user_type_id
                    JOIN      sysobjects.objects AS obj
                    ON        col.object_id = obj.object_id
                    JOIN      sysobjects.schemas AS scm
                    ON        obj.schema_id = scm.schema_id
                    LEFT JOIN sysobjects.default_constraints def
                    ON        col.default_object_id = def.object_id
                    AND       col.object_id = def.parent_object_id
                    LEFT JOIN sysobjects.extended_properties AS prop
                    ON        obj.object_id = prop.major_id
                    AND       col.column_id = prop.minor_id
                    AND       prop.name = 'MS_Description'
                    WHERE     obj.type = 'U'
    ...
    public function getListNamespacesSQL()
    {
        ...
        return "SELECT name FROM dbo.sysusers WHERE uid < 16384 ORDER BY name";
    }
    ...
    protected function getReservedKeywordsClass()
    {
        ...
        return SQLServer2012Keywords::class;
    }
