...
/**
 * @ORM\Table(name="cda_final8")
 * @ORM\Entity(repositoryClass=SeleccionCdaActualRepository::class)
 */
class SeleccionCdaActual
{
    /**
    ...
    /**
     * @ORM\Column(name="disciplina_xx", type="string", length=50, nullable=true)
     */
