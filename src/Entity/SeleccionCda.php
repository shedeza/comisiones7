...
/**
 * @ORM\Table(name="seleccion_cda9")
 * @ORM\Entity(repositoryClass=SeleccionCdaRepository::class)
 */
class SeleccionCda
{
    /**
    ...
    /**
     * @ORM\Column(name="com_dict_cl", type="integer", nullable=true)
     * @ORM\Id
     */
    private $claveComisionDictaminadora;
    ...
    /**
     * @ORM\Column(name="div_rep_xx", type="string", length=30, nullable=true)
     */
    private $nombreDivisionRepresentada;

    /**
     * @ORM\Column(name="nom_aux_xx", type="string", length=10, nullable=true, nullable=true)
     */
    private $nomAux;

    /**
     * @ORM\Column(name="disciplina_cl", type="integer", nullable=true, nullable=true)
     */
    ...
    /**
     * @ORM\Column(name="disciplina_xx", type="string", length=255, nullable=true)
     */
    ...
    public function getClaveComisionDictaminadora(): ?int
    {
        return $this->claveComisionDictaminadora;
    }

    public function setClaveComisionDictaminadora(?int $claveComisionDictaminadora): self
    {
        $this->claveComisionDictaminadora = $claveComisionDictaminadora;
    ...
    {
        return utf8_encode($this->nombreDivisionRepresentada);
    }
    ...
    {
        return utf8_encode($this->nombreDivision);
    }
    ...
    {
        return utf8_encode($this->nombreDepartamento);
    }
